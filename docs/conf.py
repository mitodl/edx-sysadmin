...
"""
edx-sysadmin documentation build configuration file.
...
project = 'edx-sysadmin'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'edx-sysadmin'
...
#
# html_title = 'edx-sysadmin v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'An Open edX plugin to enable SysAdmin panel',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'edx_sysadmin'),
                os.path.join(root_path, 'edx_sysadmin/migrations')])
